          ...
          <div className="flex flex-wrap h-full w-full justify-evenly items-center align-middle gap-y-10">
            {data?.map((item, index) => (
              <div
                ...
                className=" w-[300px] flex justify-between items-center h-full border-[1px] border-orange-400 bg-white hover:bg-orange-400 hover:text-white p-4 rounded-lg transition ease-in-out"
              >
